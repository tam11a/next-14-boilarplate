...
export const Loading = () => {
  return (
    <div className='mx-auto flex h-svh w-svw max-w-xs flex-col items-center justify-center space-y-3'>
      <div role='status'>
        <svg
          aria-hidden='true'
          className='text-muted dark:text-muted fill-primary inline h-10 w-10 animate-spin'
          viewBox='0 0 100 101'
          fill='none'
